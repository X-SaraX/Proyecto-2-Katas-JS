...
/*1.2 En base al siguiente javascript, usa destructuring para crear 3 variables llamadas 
fruit1, fruit2 y fruit3, con los valores del array. Posteriormente imprimelo por consola.*/
...
//1.4 En base al siguiente javascript, usa destructuring para crear las variables name y itv con sus respectivos valores.
...
const car = { name0: "Mazda 6", itv: [2015, 2011, 2020] };

const { name0, itv } = car;
const [itv1, itv2, itv3] = itv;

console.log(name0, itv);
