...
const videogames_RPG = videogames.filter((game) =>
  game.genders.includes("RPG"),
);

const total_score = videogames_RPG.reduce((acc, game) => acc + game.score, 0);

const media_score = total_score / videogames_RPG.length;
